...
// [1, '進む', 2, 2, '前に進む。【時間＝数字1（0〜255）×0.1秒】'],
// [1, 'さがる', 8,2,'後ろに進む。【時間＝数字1（0〜255）×0.1秒】'],
// [1, '右回転', 10,2,'右回転する。 【時間＝数字1（0〜255）×0.1秒】'],
// [1, '左回転', 11,2,'左回転する。 【時間＝数字1（0〜255）×0.1秒】'],
// [0, '右ライト', 4,2,'右ライト（あか）をつける。 【時間＝数字1（0〜255）×0.1秒】'],
// [0, '左ライト', 6,2,'左ライト（みどり）をつける。 【時間＝数字1（0〜255）×0.1秒】'],
// [1, '電子音', 105,3,'電子音を鳴らす。 【時間＝数字1(0〜255)×0.1秒】　【パルスはば＝数字2（1〜255）】　※パルスはばが大きいほど音はひくくなるよ。'],
// [1, '止まる', 0,2,'止まる。 【時間＝数字1（0〜255）×0.1秒】'],
// [1, 'ラベル', 83,2,'ラベル番号をつける。　【ラベル番号＝数字1（1〜127）】'],
// [1, 'ジャンプ', 84,2,'ラベル番号のところまでジャンプしてそこからじっこうする。【ラベル番号＝数字1（1〜127）】'],
// [1, '信号ありでジャンプ', 108,3,'数字1のラベル番号に数字2の信号入力ポートがせつぞくされていたらにジャンプする。【ジャンプ先のラベル番号＝数字1（1〜127）】　【信号入力ポート＝数字2（1〜4）】'],
// [1, '信号なしでジャンプ', 109,3,'数字1のラベル番号に数字2の信号入力ポートがはなれていたらにジャンプする。【ジャンプ先のラベル番号＝数字1（1〜127）】　【信号入力ポート＝数字2（1〜4）】'],
// [1, '左まえ',1,2,'左タイヤだけを前に回す（右タイヤは動かさない）。 【時間＝数字1（0〜255）×0.1秒】　※右前の方へ大きく回ることになるよ。'],
// [1, '左うしろ',7,2,'左タイヤだけを後ろに回す（右タイヤは動かさない）。 【時間＝数字1（0〜255）×0.1秒】'],
// [1, '右まえ', 3,2,'右タイヤだけを前に回す（左タイヤは動かさない）。 【時間＝数字1（0〜255）×0.1秒】　※左方向へ大きく回ることになるよ。'],
// [1, '右うしろ', 9,2,'右タイヤだけを後ろに回す（左タイヤは動かさない）。 【時間＝数字1（0〜255）×0.1秒】'],
// [1, 'ブザー', 80,2,'ブザーを鳴らす。 【時間＝数字1（0〜255）×0.1秒】'],
